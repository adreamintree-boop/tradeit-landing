  ...
  const cards: FloatingCard[] = [
    {
      ...
      pos: "lg:left-[0%] xl:left-[4%] 2xl:left-[10%] top-[34%] lg:top-[34%] xl:top-[36%] 2xl:top-[38%]",
    ...
    },
    {
      ...
      trend: "12.7%",
      Icon: Ship,
      pos: "lg:right-[0%] xl:right-[3%] 2xl:right-[6%] top-[30%] lg:top-[30%] xl:top-[32%] 2xl:top-[32%]",
      hideOn: "hidden lg:block",
    ...
    },
    {
      ...
      trend: "9.6%",
      Icon: Weight,
      pos: "lg:right-[0%] xl:right-[10%] 2xl:right-[18%] top-[58%] lg:top-[58%] xl:top-[60%] 2xl:top-[62%]",
      hideOn: "hidden lg:block",
